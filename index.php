...
$fedex_data['Key']='TW9NwkGk2G8QMjSP';
$fedex_data['Password']='QTHWHw7uUS9YB47XpYhtWMgrq';
$fedex_data['AccountNumber']='355520919';
$fedex_data['MeterNumber']='106739435';
$fedex_data['CarrierCode']='';
$fedex_data['Address']='790 Penllyn Pike	Suite 217';
$fedex_data['City']='Blue Bell';
$fedex_data['StateOrProvinceCode'] = 'PA';
$fedex_data['PostalCode']='19422';
$fedex_data['CountryCode']='US';
...
<ns1:UserCredential>
<ns1:Key>'.$fedex_data['Key'].'</ns1:Key>
<ns1:Password>'.$fedex_data['Password'].'</ns1:Password>
</ns1:UserCredential></ns1:WebAuthenticationDetail>
<ns1:ClientDetail>
<ns1:AccountNumber>'.$fedex_data['AccountNumber'].'</ns1:AccountNumber>
<ns1:MeterNumber>'.$fedex_data['MeterNumber'].'</ns1:MeterNumber>
</ns1:ClientDetail>
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://gateway.fedex.com:443/web-services');
